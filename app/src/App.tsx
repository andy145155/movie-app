...
const GetStarted = lazy(() => import('@/pages/getStarted.ts'));
const SignIn = lazy(() => import('@/pages/signIn.ts'));
const Register = lazy(() => import('@/pages/register.ts'));
const ConfirmSignup = lazy(() => import('@/pages/confirmSignup.ts'));

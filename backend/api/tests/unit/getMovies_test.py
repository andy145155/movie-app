...
class TestGetMoviesLambda(TestCase):
    ...
    def setUp(self) -> None:
        ...
        dynamodb.create_table(
            ...
            AttributeDefinitions=[{"AttributeName": "movieId", "AttributeType": "N"},{"AttributeName": "index", "AttributeType": "N"}],
        ...
        self.mocked_dynamodb_class.table.put_item(Item={"movieId":1,
                                                        "index":1})

        self.mocked_dynamodb_class.table.put_item(Item={"movieId":2,
                                                        "index":2})
    ...
    def test_get_movies_index_list(self):
        ...
        """
        from api.functions.getMovies import get_movies_index_list
    ...
    def test_fetch_movie_by_index(self):
        ...
        """
        from api.functions.getMovies import fetch_movie_by_index
        index = 1
    ...
    def load_sample_event_from_file(self, test_event_file_name: str) ->  dict:
        ...
        """
        event_file_name = f"api/tests/events/{test_event_file_name}.json"
    ...
    @patch("api.functions.getMovies.get_movies_index_list")
    @patch("api.functions.getMovies.fetch_movie_by_index")
    def test_lambda_handler_valid_event(self,
        ...
        from api.functions.getMovies import handler
